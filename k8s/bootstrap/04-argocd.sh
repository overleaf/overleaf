...
echo ""
echo "We need to build the images and push them to the repo for k8s to use. They will currently be in ImagePullBackOff."
echo ""
echo "Next: run 05-build-push.sh, then sync the app using Argo once this is complete."
echo ""